...
class CommandDslTest extends Test {
  describe("ConfigDsl tests") {
    ...
    it("compiles for command with config and run with same type") {
      cmd("command1") {
        takes(group[String](req[String] --"field")) ::
        runs[String](s => ())
      }: CommandDsl[Command]
    }
    ...
    it("compiles for command with config and run with different type") {
      ...
      cmd("command1") {
        takes(group[A](req[String] --"field" -'f')) ::
        runs[A](s => ())
      }: CommandDsl[Command]
    }
    ...
    it("compiles for command with subcommands") {
      cmd("command1") {
        cmd("subcommand1") {
          takes(group[String](req[String] -- "second")) ::
          runs[String](s => ())
        }
      }: CommandDsl[Command]
    }
      ...
      illTyped("""
        cmd("command1") {
          subcommands[String] { parent =>
            cmd("subcommand1") {
              takes(group[String](parent :: req[String] -- "second")) ::
              runs[A](s => ())
            }
          }
        }: CommandDsl[Command]""")
    ...
    it("compiles for command with multiple subcommands") {
      cmd("command1") {
        cmd("subcommand1") {
          takes(group[String](req[String] -- "first")) ::
          runs[String](s => ())
        } ::
        cmd("subcommand2") {
          takes(group[String](req[String] -- "second")) ::
        ...
        cmd("subcommand3") {
          takes(group[String](req[String] -- "third")) ::
          runs[String](s => ())
        }
      }: CommandDsl[Command]
    }
    ...
    it("compiles for command with config and multiple subcommands of N depth") {
      ...
      cmd("command1") {
        ...
        cmd("subcommand1") {
          ...
          cmd("subcommand2") {
            takes(group[String](req[String] -- "subfield2")) ::
            cmd("subcommand3") {
        ...
        cmd("subcommand5") {
          takes(group[String](req[String] -- "subfield5")) ::
          runs[A](s => ())
        }
      }: CommandDsl[Command]
    }
    ...
    it("compiles for command with config and multiple subcommands complex tree") {
      ...
      cmd("command1") {
        ...
        cmd("subcommand7") {
          takes(group[String](req[String] --"subfield7")) ::
          runs[(A, String)](s => ())
        } ::
        cmd("subcommand8") {
